    ...
    <div className='fixed inset-0 z-50 flex items-center justify-center bg-black/50'>
      <div className='relative w-full max-w-md rounded-md bg-white p-6 shadow-lg'>
        ...
        <div className='space-y-4'>
          ...
          <DetailRow label='User Name' value={data.name} />
          <DetailRow label='Transaction Amount' value={data.amount} />
          <DetailRow label='Subscription Purchased' value={data.subscription} />
        </div>

        <Button className='mt-6 w-full bg-teal-800 hover:bg-teal-700'>
          Download
        </Button>
      </div>
    </div>
